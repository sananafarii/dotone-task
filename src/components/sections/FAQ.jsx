  ...
  return (
    <section className="w-full max-w-[1440px] mx-auto px-[108px] mt-[120px]">
      ...
      <div className="flex items-end justify-between gap-[40px]">
        {/*  pic */}
        <div className="relative w-[392px] h-[443px] rounded-[24px] overflow-hidden flex-shrink-0">
          <img src={FAQImage} alt="FAQ" className="w-full h-full object-cover" />
          <div
            className="absolute inset-0"
            style={{
              background: 'linear-gradient(180deg, rgba(0, 0, 0, 0) 12.59%, rgba(0, 0, 0, 0.2) 54.89%)',
            }}
          />
        </div>
            ...
            return (
              <div key={item.id}>
                ...
                <button
                  ...
                  className={`w-full h-[50px] rounded-[14px] bg-surface flex items-center justify-between px-[16px] mb-[8px] transition-all ${
                    index === 0 ? 'mt-[40px]' : 'mt-[16px]'
                  } hover:bg-surface/80`}
                >
                ...
                {/* answer */}
                {isOpen && (
                  <div className="w-full rounded-[14px] bg-black text-white px-[16px] pt-[14px] pb-[14px] mb-[10px] animate-in fade-in slide-in-from-top-2 duration-300">
                    <div className="h-[1px] w-full bg-[#373737] mb-[10px]"></div>
                    <p className="text-[12px] leading-[160%] text-justify">
                      {item.a}
                    </p>
                  </div>
                )}
