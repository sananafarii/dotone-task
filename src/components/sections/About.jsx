    ...
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <main className="w-[1224px] mx-[108px] pt-[64px]">
        ...
        <section className="relative w-[1224px] h-[268px] mt-[16px] rounded-[6px] overflow-hidden">
          {/* title and paragraph*/}
          <div className="absolute top-0 right-0 w-[496px] h-[268px] bg-white rounded-l-[6px] p-[20px]">
          ...
          <div className="absolute left-0 top-[35px] w-[696px] h-[193px]">
            ...
            {/* middle row: travel services + bag icon */}
            <div className="absolute right-[240px] top-0 flex items-center gap-[12px] z-10">
              ...
              <div className="w-[53px] h-[52px] rounded-[16px] bg-surface flex items-center justify-center">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path
                    d="M7 7h10a3 3 0 013 3v5a3 3 0 01-3 3H7a3 3 0 01-3-3v-5a3 3 0 013-3z"
                    stroke="#292D32"
                    strokeWidth="1.5"
                  />
                  <path
                    d="M9 7V6a3 3 0 013-3 3 3 0 013 3v1"
                    stroke="#292D32"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                  />
            ...
            {/* bottom row: travel booking + travel planning */}
              ...
              <div className="flex items-center gap-[12px]">
                <div className="w-[51px] h-[52px] rounded-[16px] bg-surface flex items-center justify-center">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    />
                    <path
                      d="M7.5 16.5L10.5 13.5L13.5 10.5L16.5 7.5"
                      stroke="#292D32"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                    />
